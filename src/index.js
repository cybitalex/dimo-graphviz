...
var settingsModalCloseButton = document.getElementById("settingsModalCloseButton");

// When the user clicks on the button, open the modal 
const settingsModalOpen = function() {
  settingsModal.style.display = "block";
}

// When the user clicks on <span> (x), close the modal
settingsModalCloseButton.onclick = function() {
